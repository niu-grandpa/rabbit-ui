                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span>显示的数字，大于</span><code>maxCount</code
                                ><span>时，显示</span><code>${maxCount}+</code
                                ><span>，为 0 时隐藏</span>
                            </td>
                            <td><span>-</span></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    >不展示数字，只有一个小红点，如需隐藏 dot，详见下方 config
                                    方法</span
                                >
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    >使用预设的颜色，可选值为
                                    success、primary、normal、error、warning、info</span
                                >
                            </td>
                            <td><span>-</span></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    >设置 Badge 为状态点，可选值为
                                    success、processing、default、error、warning</span
                                >
                            </td>
                            <td><span>-</span></td>
                        </tr>
