                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>设置 indeterminate 状态，只负责样式控制</span>
                            </td>
                            <td style="text-align: left"><span>false</span></td>
                        </tr>
                    </tbody>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-align: left"><span>size</span></td>
                            <td style="text-align: left">
                                <span>多选框组的尺寸，可选值为 </span><code>large</code
                                ><span>、</span><code>small</code><span> 或者不设置</span>
                            </td>
                            <td style="text-align: left"><span>-</span></td>
                        </tr>
                    </tbody>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><span>el</span></td>
                            <td>
                                <span>配置当前选定的 checkbox，必须是选择器名称或者元素名</span>
                            </td>
