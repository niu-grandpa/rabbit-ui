                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>输入框尺寸，可选值为</span><code>large</code><span>、</span
                                ><code>small</code><span>或者不填</span>
                            </td>
                            <td style="text-align: left"><span>-</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span
                                    >指定从 formatter 里转换回数字的方式，和 formatter
                                    搭配使用</span
                                >
                            </td>
                            <td style="text-align: left"><span>-</span></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>给内部实际的输入框元素设置 </span><code>id</code>
                            </td>
                            <td style="text-align: left"><span>-</span></td>
                        </tr>
                    </tbody>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td><span>el</span></td>
                            <td>
                                <span>配置当前选定的 input-number，必须是选择器名称或者元素名</span>
                            </td>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>数值改变时的回调，返回当前值</span>
                            </td>
                            <td style="text-align: left">
                                <span>(value: number) =&gt; void</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>(event: InputEvent) =&gt; void</span>
                            </td>
                        </tr>
                        <tr>
