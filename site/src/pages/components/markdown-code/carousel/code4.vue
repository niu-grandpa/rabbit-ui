                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>自动切换的时间间隔，单位为毫秒</span>
                            </td>
                            <td style="text-align: left"><span>2000</span></td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span
                                    >指示器的位置，可选值为 inside
                                    （内部），outside（外部），none（不显示）</span
                                >
                            </td>
                            <td style="text-align: left"><span>inside</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>指示器的触发方式，可选值为 click（点击），hover（悬停）</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left"><span>ease</span></td>
                        </tr>
                        <tr>
                            <td style="text-align: left"><span>effect</span></td>
                            <td style="text-align: left">
                                <span>动画效果函数，可切换为渐显 </span><code>fade</code>
                            </td>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span
                                    >幻灯片切换时触发，目前激活的幻灯片的索引，原幻灯片的索引</span
                                >
                            </td>
                            <td style="text-align: left">
