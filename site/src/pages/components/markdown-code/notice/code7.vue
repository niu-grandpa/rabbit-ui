<template>
    <div class="markdown-code">
        <div class="code-write">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    >通知提醒的内容，为空或不填时，自动应用仅标题模式下的样式</span
                                >
                            </td>
                            <td><span>String</span></td>
                            <td><span>-</span></td>
            ...
            <h3>
                <a
                    name="通过异步或者关闭按钮关闭通知后为什么-then--接口的回调事件不生效"
                    class="md-header-anchor"
                ></a
                ><span>通过异步或者关闭按钮关闭通知后，为什么 </span><code>then</code
            ...
            <p>
                <span>如果您想通过手动移除通知后接着添加回调事件，请使用 </span><code>onClose</code
