<template>
    <div class="markdown-code">
        <div class="code-write">
            <h4>
                <a name="modal-instance" class="md-header-anchor"></a><span>Modal instance</span>
            </h4>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span>取消按钮的文字，只在</span><code>Modal.confirm()</code
                                ><span>下有效</span>
                            </td>
                            <td><span>String</span></td>
                            <td><span>取消</span></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ><code>Modal.remove()</code><span>来关闭对话框</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span>点击取消的回调，只在</span><code>Modal.confirm()</code
                                ><span>下有效</span>
                            </td>
                            <td><span>Function</span></td>
                            <td><span>-</span></td>
