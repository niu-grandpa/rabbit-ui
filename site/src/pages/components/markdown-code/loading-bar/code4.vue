    ...
    <div class="markdown-code">
        <div class="code-write">
            ...
            <ul>
                ...
                <li><code>Rabbit.Loading.update(percent)</code></li>
            </ul>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span>percent，指定的进度百分比</span></td>
                        </tr>
                    </tbody>
                </table>
            </figure>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <span>进度条的颜色，默认为 Rabbit 主色</span>
                            </td>
                            <td style="text-align: left"><span>String</span></td>
                            <td style="text-align: left"><span>primary</span></td>
                        </tr>
                        <tr>
                            <td style="text-align: left"><span>failedColor</span></td>
                            <td style="text-align: left">
                                <span>失败时的进度条颜色，默认为 Rabbit 主色</span>
                            </td>
                            <td style="text-align: left"><span>String</span></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left"><span>Number</span></td>
                            <td style="text-align: left"><span>800</span></td>
                        </tr>
                    </tbody>
                </table>
            </figure>
