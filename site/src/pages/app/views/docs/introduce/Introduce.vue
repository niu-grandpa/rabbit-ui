<template>
  <article class="markdown">
    ...
    <p>
      ...
      组件库，主要使用于 PC 界面。其提供的组件的 HTML 代码奉行着简洁至上、简单表意、易于分辨的准则。
    </p>
    <h2 id="特性">特性</h2>
    <ul>
    ...
    <p>
      在浏览器中使用 <code>script</code> 和 <code>link</code> 标签直接引入文件，并使用全局变量
      <code>Rabbit</code>。
    </p>
    <AZCode2 />
    <h2 id="示例">示例</h2>
    ...
    <button type="button" class="rab-btn rab-btn-primary" @click="handleStar"> 模拟进度条 </button>
